...
<script  type="text/javascript">
    ...
    var zipcode = document.getElementById('zipcode').value;
     xhttp = new XMLHttpRequest(); // Obect of xmlhttp request
        ...
        parameters = "email= "+email+"&bday="+bday+"&nationality="+nationality+"&gender="+gender+"&pnumber="+pnumber+"&expdate="+expdate+"&ccode="+ccode+"&mnumber="+mnumber+"&straddr="+straddr+"&city="+city+"&state="+state+"&country="+country+"&zipcode="+zipcode+"&first="+first+ "&last="+last+"&pid="+<?php echo $_GET['ID']; ?>;
...
var xhttp;
                    ...
                    xhttp.open("POST", "adminbackend.php", true); // this is the url
                    parameters = "pid= "+<?php echo $_GET['ID'] ;?>;
                    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                    xhttp.send(parameters);
    // var array = JSON.parse(JSON.stringify(x));
    //  // alert(array.fname)
